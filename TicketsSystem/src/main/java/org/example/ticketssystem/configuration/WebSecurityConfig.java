package org.example.ticketssystem.configuration;

import org.example.ticketssystem.service.Endpoints;
import org.example.ticketssystem.service.userdetailsservice.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().and().formLogin()  // активирует механизм аутентификации через форм
                ...
                .defaultSuccessUrl("/customerInfo")  // URL, на который польз. будет перенаправлен после успешного входа в систему
